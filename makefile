...
demo: demo.cpp demo_ui.h map_maker.h map_maker.cpp abstract_solver.h abstract_solver.cpp uniform_cost_search.h a_star.h w_a_star.h util.h util.cpp my_heap.cpp my_hash.cpp sequential_a_star.h sequential_a_star.cpp integrated_a_star.h integrated_a_star.cpp
	g++ -std=gnu++11 -g demo.cpp demo_ui.h map_maker.h map_maker.cpp abstract_solver.h abstract_solver.cpp uniform_cost_search.h a_star.h w_a_star.h util.h util.cpp my_heap.cpp my_hash.cpp sequential_a_star.h sequential_a_star.cpp integrated_a_star.h integrated_a_star.cpp -I${OPENCV_INCLUDE_PATH} -L$(OPENCV_LIB_PATH) $(USED_LIB) -o bin/demo
