...
bin_a_star:
	g++ -std=gnu++11 -g experiment_a_star.cpp map_maker.h map_maker.cpp abstract_solver.h abstract_solver.cpp uniform_cost_search.h util.h my_heap.cpp my_hash.cpp -I$(OPENCV_INCLUDE_PATH) -L$(OPENCV_LIB_PATH) $(USED_LIB) -o bin/bin_a_star

bin_w_a_star:
	g++ -std=gnu++11 -g experiment_w_a_star.cpp map_maker.h map_maker.cpp abstract_solver.h abstract_solver.cpp uniform_cost_search.h util.h my_heap.cpp my_hash.cpp -I$(OPENCV_INCLUDE_PATH) -L$(OPENCV_LIB_PATH) $(USED_LIB) -o bin/bin_w_a_star
